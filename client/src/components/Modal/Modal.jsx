  ...
  return ReactDom.createPortal(
    <>
      ...
      <div className="Modal_styles fixed top-1/2 left-1/2  transform -translate-x-1/2 -translate-y-1/2 bg-white p-20 z-100 flex flex-col">
        {children}
        <button onClick={onClose} className="block uppercase mx-auto shadow bg-indigo-800 hover:bg-indigo-700 focus:ring focus:outline-none text-white text-xs py-3 px-10 rounded">Close</button>
      </div>
    </>,
